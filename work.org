...
** <2022-01-22 Sat> 
** <2022-01-23 Sun>
*** TODO Fix up the slope tile edge cases (not necessarily in this order)
    - [ ] Fix what happens when approaching from the bottom.
    - [ ] Fix snapping when I'm not high enough to snap into it
...
*** TODO Clean up slope tile code
    :LOGBOOK:
    CLOCK: [2022-01-23 Sun 16:44]
    CLOCK: [2022-01-23 Sun 16:24]--[2022-01-23 Sun 16:44] =>  0:20
    :END:
*** TODO [0/6] (??) Tile world editor (pt1, really crufty bad UI without mouse, just place different tiles)
